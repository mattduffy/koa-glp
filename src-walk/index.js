 ...
 * @file src-walk/index.js The entry point the walking app.
 */
...
import { _log, _error } from '../src/utils/logging.js'
...
dotenv.config({ path: path.resolve(appRoot, 'config/walk.env'), processEnv: appEnv, debug: showDebug })
